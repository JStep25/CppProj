...
public:
    ...
    void setupUi(QWidget *statScreen)
    {
        ...
        avrLength->setGeometry(QRect(220, 100, 71, 20));
        ...
        genreBox->setGeometry(QRect(430, 10, 161, 28));
